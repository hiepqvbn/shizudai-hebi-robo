...
family_names = ["Arm"]
#family_names = ["X5-1"]
# family_names = ["DiffDrive"]

#family_names = ["Arm","X5-1"]
#family_names = ["DiffDrive","Arm"]
#family_names = [ "DiffDrive", "DiffDrive", "Arm", "Arm", "X5-1"]

#module_names = ["J1_base"]
# module_names = ["J1_base","J2_shoulder","J3_elbow"]
module_names = ["J2_shoulder","J3_elbow"]
#module_names = ["X-01069"]
# module_names = ["W2_right"]
#module_names = ["W1_left","W2_right"]

#module_names = ["W2_right","J1_base"]
#module_names = ["W1_left", "W2_right","J1_base","J3_elbow","X-01069"]
