...
class Xbox360Controller:
    ...
    def connect(self):
        try:
            ...
            if not self.hasBeenConnected:
                self._hasBeenConnected = True
        except FileNotFoundError:
            # print('controller device with index {index} ''was not found!'.format(index=index))
            self._isConnected = False
        ...
        # print('event thread: {}'.format(self._event_thread.getName()))
    ...
    def _get_event_file(self):
        ...
        # print('event file {}'.format('/dev/input/event{number}'.format(number=event_number)))
